...
const Sidebar = ({ open }) => {
  ...
  const [performanceOpen, setPerformanceOpen] = useState(location.pathname.startsWith('/performance'));
                          ...
                          onClick={
                            item.text === 'Analytics' ? handleToggleAnalytics :
                              item.text === 'HR Tools' ? handleToggleAiTools :
                                item.text === 'Performance' ? handleTogglePerformance : null
                          }
                          sx={{
                            py: 1.2,
                            pl: 2,
                        ...
                        >
                          ...
                          {item.text === 'Analytics' ? (analyticsOpen ? <ExpandLess /> : <ExpandMore />) :
                            item.text === 'HR Tools' ? (aiToolsOpen ? <ExpandLess /> : <ExpandMore />) :
                              item.text === 'Performance' ? (performanceOpen ? <ExpandLess /> : <ExpandMore />) : null}
                        </ListItemButton>
                      </Tooltip>
                    ) : (
                      <Tooltip title={!open ? item.text : ''} placement="right">
                          ...
                          <ListItem key={subItem.text} disablePadding>
                            <ListItemButton
                              ...
                              sx={{
                                py: 1,
                                pl: 6,
                                bgcolor: location.search === subItem.path.split('?')[1] ? alpha(subItem.color || theme.palette.primary.main, 0.12) : 'transparent',
                                '&:hover': {
                                  bgcolor: alpha(subItem.color || theme.palette.primary.main, 0.08)
                                },
                                borderRadius: '0 20px 20px 0',
                            ...
                            >
                              <ListItemIcon
                                sx={{
                                  minWidth: 36,
                                  color: location.search.includes(subItem.path.split('?')[1]) ? subItem.color || theme.palette.primary.main : 'inherit',
                                  fontSize: '1.2rem'
                                }}
                              >
                                {subItem.icon}
                              ...
                              <ListItemText
                                primary={
                                  <Typography
                                    variant="body2"
                                    sx={{
                                      fontWeight: location.search.includes(subItem.path.split('?')[1]) ? 600 : 400,
                                      fontSize: '0.875rem',
                                      color: location.search.includes(subItem.path.split('?')[1]) ? theme.palette.text.primary : theme.palette.text.secondary
                                    }}
                                  >
                                    {subItem.text}
                                  </Typography>
