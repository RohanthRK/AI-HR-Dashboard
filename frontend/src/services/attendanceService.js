...
const attendanceService = {
  ...
  clockIn: async (location = null) => {
    try {
      ...
      const response = await attendanceAPI.post('clock-in/', data); // No leading slash
  ...
  getEmployeeAttendance: async (employeeId, params = {}) => {
    try {
      const response = await attendanceAPI.get(`employee/${employeeId}/`, { params });
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  updateAttendance: async (attendanceId, attendanceData) => {
    try {
      const response = await attendanceAPI.put(`${attendanceId}/update/`, attendanceData);
      return response.data;
    } catch (error) {
      throw error;
    }
  ...
  deleteAttendance: async (attendanceId) => {
    try {
      const response = await attendanceAPI.delete(`${attendanceId}/delete/`);
      return response.data;
    } catch (error) {
      throw error;
    }
