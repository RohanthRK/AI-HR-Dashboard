...
const teamService = {
  ...
  // Get all teams from debug endpoint
  getTeamsDebug: async () => {
    try {
      console.log('Fetching teams from debug endpoint...');
      const response = await teamAPI.get('/teams/debug/');
  ...
  updateTeam: async (teamId, teamData) => {
    try {
      const response = await teamAPI.put(`/teams/${teamId}/`, teamData);
      return response.data;
    } catch (error) {
  ...
  deleteTeam: async (teamId) => {
    try {
      const response = await teamAPI.delete(`/teams/${teamId}/`);
      return response.data;
    } catch (error) {
  ...
  createTeamMongoDB: async (teamData) => {
    try {
      ...
      const response = await teamAPI.post('/teams/mongodb_create/', teamData);
  ...
  getTeamReviews: async () => {
    try {
      ...
      const response = await teamAPI.get('/ai/team-reviews/');
  ...
  getTeamReviewsByTeamId: async (teamId) => {
    try {
      ...
      const response = await teamAPI.get(`/ai/team-reviews/${teamId}/`);
      console.log('Team reviews fetched successfully:', response.data);
      return response.data;
    } catch (error) {
  ...
  createTeamReview: async (reviewData) => {
    try {
      ...
      const response = await teamAPI.post('/ai/team-reviews/', reviewData);
  ...
  updateTeamReview: async (teamId, reviewData) => {
    try {
      ...
      const response = await teamAPI.put(`/ai/team-reviews/${teamId}/`, reviewData);
