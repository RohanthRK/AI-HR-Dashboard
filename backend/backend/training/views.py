...
from hr_backend.db import training
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/training/{item_id}
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/training/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/training/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/training/{item_id}
    """
