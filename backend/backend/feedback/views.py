...
from hr_backend.db import feedback
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/feedback/{item_id}
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/feedback/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/feedback/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/feedback/{item_id}
    """
