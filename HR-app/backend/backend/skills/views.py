...
from hr_backend.db import skills
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/skills/{item_id}
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/skills/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/skills/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/skills/{item_id}
    """
