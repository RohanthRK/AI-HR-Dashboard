...
from hr_backend.db import projects
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/projects/{item_id}
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/projects/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/projects/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/projects/{item_id}
    """
