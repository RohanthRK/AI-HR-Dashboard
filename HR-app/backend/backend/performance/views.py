...
from hr_backend.db import performance
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/performance/{item_id}
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/performance/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/performance/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/performance/{item_id}
    """
