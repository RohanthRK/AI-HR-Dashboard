...
from hr_backend.db import time_tracking
...
def list_items(request):
    ...
    Endpoint: GET /api/time_tracking/
    """
...
def get_item(request, item_id):
    ...
    Endpoint: GET /api/time_tracking/{item_id}
    """
...
def create_item(request):
    """
    Create a new item
    Endpoint: POST /api/time_tracking/
    """
...
def update_item(request, item_id):
    ...
    Endpoint: PUT /api/time_tracking/{item_id}
    """
...
def partial_update_item(request, item_id):
    ...
    Endpoint: PATCH /api/time_tracking/{item_id}
    """
...
def delete_item(request, item_id):
    """
    Delete an item
    Endpoint: DELETE /api/time_tracking/{item_id}
    """
