          ...
          if (matchingTeam) {
            ...
            foundTeam = {
              ...
              leader: matchingTeam.employees.length > 0 ? {
                ...
                email: `${matchingTeam.employees[0].name.toLowerCase().replace(/\s+/g, '.')}@company.com`,
              ...
              members: matchingTeam.employees.map(employee => ({
                ...
                hire_date: new Date(Date.now() - Math.floor(Math.random() * 1000 * 60 * 60 * 24 * 365 * 3)).toISOString().split('T')[0]
              })),
              projects: [
                { 
                        ...
                        <Box display="flex" alignItems="center">
                          <Avatar 
                            sx={{ 
                              ...
                              height: 32, 
                              mr: 1, 
                              bgcolor: member.id === team.leader.id ? 'primary.main' : 'secondary.main' 
                            }}
                          >
