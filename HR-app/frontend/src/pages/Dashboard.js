              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1, pt: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 500 }}>Employees</Typography>
                  </Box>
                  <Typography 
                    variant="h3" 
                    component="div" 
              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1, pt: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 500 }}>Teams</Typography>
                  </Box>
                  <Typography 
                    variant="h3" 
                    component="div" 
              ...
              >
                ...
                <CardContent sx={{ flexGrow: 1, pt: 3 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="h6" sx={{ fontWeight: 500 }}>Today's Attendance</Typography>
                  </Box>
                  <Box sx={{ mb: 2 }}>
